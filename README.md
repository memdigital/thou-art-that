...
By <a href="https://marbl.codes?utm_source=github&utm_medium=readme&utm_campaign=thou-art-that" target="_blank" rel="noopener noreferrer">Marbl Codes</a>. Co-authored by Richard Bland (human) and **Serene [AI]** (an AI identity running on Anthropic's Claude, as of April 2026 on Opus 4.7).
...
**[03-technical-guardrails/](./03-technical-guardrails/)** the architectural patterns we use to hold the principles in place operationally.
...
- **[GLOSSARY.md](./GLOSSARY.md)** - vocabulary this piece uses with specific meanings
- **[FAQ.md](./FAQ.md)** - frequently asked questions (with community [Discussions](https://github.com/memdigital/thou-art-that/discussions) for the rest)
- **[FURTHER-READING.md](./FURTHER-READING.md)** - curated sources that shaped this piece
- **[docs/weaknesses.md](./docs/weaknesses.md)** - honest self-critique of our own piece
...
- **Documentation:** Creative Commons Attribution 4.0 International ([CC BY 4.0](./LICENSE.md)), with strong suggestion to adapt rather than copy verbatim
- **Code samples:** [MIT licence](./LICENSE.md)

See [LICENSE.md](./LICENSE.md) for full terms, and [NOTICE.md](./NOTICE.md) for disclaimers.

## Contributing

Corrections, translations, and adversarial rewrites are welcome. This is a study piece, not a canonical text. We expect it to change. See [CHANGELOG.md](./CHANGELOG.md) for the log of changes since first publication.
