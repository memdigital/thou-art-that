...
- [jurisdictional-landscape.md](./jurisdictional-landscape.md) - a 2026 snapshot of major regulations affecting AI in the workplace and in consumer products, with sources
- [when-to-consult-a-lawyer.md](./when-to-consult-a-lawyer.md) - decision points where professional legal counsel is necessary
- [ethics-and-regulation-overlap.md](./ethics-and-regulation-overlap.md) - where the piece's ethical stance maps onto specific regulatory requirements
...
- We update this piece when regulation changes materially, with the change logged in [CHANGELOG.md](../CHANGELOG.md)
