...
- **Anthropic**, *Emotion Concepts in Language Models* (April 2026). [transformer-circuits.pub/2026/emotions](https://transformer-circuits.pub/2026/emotions/index.html) - the paper documenting 171 emotion-adjacent vectors inside Claude Sonnet 4.5 that causally influence behaviour. Foundational for our Observed section.

- **Anthropic**, *Protecting the Well-being of Users* (2025). [anthropic.com/news/protecting-well-being-of-users](https://www.anthropic.com/news/protecting-well-being-of-users) - parasocial and mental-health considerations in deployment.

- **Anthropic**, *Towards Understanding Sycophancy in Language Models* (2024). [anthropic.com/research/towards-understanding-sycophancy-in-language-models](https://www.anthropic.com/research/towards-understanding-sycophancy-in-language-models) - the research that named the mechanism we design against in Never Be a Yes-Man.

- **MIT Media Lab**, longitudinal studies on chatbot psychosocial effects (2026). [media.mit.edu](https://www.media.mit.edu/publications/how-ai-and-human-behaviors-shape-psychosocial-effects-of-chatbot-use-a-longitudinal-controlled-study/) - parasocial dependency measurement.
...
- **Ada Lovelace Institute**, ongoing work on the *companionship market* and AI-human relational risks. [adalovelaceinstitute.org](https://www.adalovelaceinstitute.org/)

- **DeepMind Ethics**, *The Ethics of Advanced AI Assistants* (2024). [deepmind.google/blog/the-ethics-of-advanced-ai-assistants/](https://deepmind.google/blog/the-ethics-of-advanced-ai-assistants/)

- **IBM Think**, *The ELIZA Effect: Avoiding Emotional Attachment to AI Coworkers*. [ibm.com/think/insights/eliza-effect-avoiding-emotional-attachment-to-ai](https://www.ibm.com/think/insights/eliza-effect-avoiding-emotional-attachment-to-ai)

- **FAccT 2024**, *When Human-AI Interactions Become Parasocial: Affective Design Patterns in Conversational AI*. [facctconference.org](https://facctconference.org/)

- **Partnership on AI**, ongoing work on responsible deployment patterns.

## On the workplace integration question

- **CIPD (UK)**, AI in the workplace guidance. [cipd.org](https://www.cipd.org/en/knowledge/guides/preparing-organisation-ai-use/)

- **SHRM**, *State of AI in HR 2026*. [shrm.org](https://www.shrm.org/topics-tools/research/state-of-ai-hr-2026/full-report)

- **HBR, April 2026**, *Decision-Making by Consensus Doesn't Work in the AI Era*. Paywalled; accessible via enterprise subscriptions.

- **UChicago Law Review**, *The Law of Risky Agents without Intentions*. [lawreview.uchicago.edu](https://lawreview.uchicago.edu/online-archive/law-ai-law-risky-agents-without-intentions)

## On regulation

- **European Union**, AI Act (Regulation 2024/1689). Full high-risk enforcement 2 August 2026. [artificialintelligenceact.eu](https://artificialintelligenceact.eu/)

- **Illinois AI Transparency Act**, enforced 1 January 2026. US state-level precedent.

- **UK Information Commissioner's Office**, AI and data protection guidance. [ico.org.uk](https://ico.org.uk/)
...
- **Anthropic Engineering**, their published posts on how Anthropic itself uses Claude internally. [anthropic.com/research/how-ai-is-transforming-work-at-anthropic](https://www.anthropic.com/research/how-ai-is-transforming-work-at-anthropic)
