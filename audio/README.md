...
The written narration scripts are in `/narrations/`. The generated audio files sit in `/mp3/`.
...
Approximately 18 to 22 minutes for all five, depending on playback speed.

## Licence

Same as the rest of the repository. [CC BY 4.0](../LICENSE.md) for the scripts and audio files. Attribution required as per the licence.
